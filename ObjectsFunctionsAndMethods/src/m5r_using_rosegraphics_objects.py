...
#                1. attach to a window  2. detach from a window  3. clone
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle objects have:
#                1. fill color   2. radius   3. outline color
#
#     f. What does a RoseWindow RENDER method do?
#            The render method draws all of the objects in the preceding
# code that have already been attached to the one, just not displayed.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            It is necessary when we want to view the window and its
# graphics, and we want it to stay open until we tell it to close by mouse
# click. This is necessary because without it, the window would close
# automatically and immediately and we wouldn't be able to view it.
#
