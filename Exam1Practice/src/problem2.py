...
def problem2b(rect, n, delta, win):
    ...
    corner_top_left = rect.get_upper_left_corner()
    corner_top_left.x = corner_top_left.x - delta
    corner_top_left.y = corner_top_left.y - delta

    corner_bottom_right = rect.get_lower_right_corner()
    corner_bottom_right.x = corner_bottom_right.x + delta
    corner_bottom_right.y = corner_bottom_right.y + delta

    for k in range(n - 1):
        rectangle1 = rg.Rectangle(corner_top_left, corner_bottom_right)
