...
#
# On Line 13 above, replace Joshua Eckels  with your OWN name.
#
...
#
########################################################################
josh = rg.SimpleTurtle('turtle')
josh.pen = rg.Pen('purple', 40)
josh.speed = 100  # Faster
josh.forward(500)
josh.left(91)
josh.forward(100)
josh.backward(200)
