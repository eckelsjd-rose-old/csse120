...
def run_test_practice_problem2a():
    ...
    print('Actual', practice_problem2a([1, 2, 3], 2))
    print('')

    # Test 2
    print('Expected:', '[9, 14, 2]')
    print('Actual', practice_problem2a([5, 10, -2], 4))
    print('')
    ...
    # Test 4
    print('Expected:', '[6, 3, -7]')
    print('Actual', practice_problem2a([9, 6, -4], -3))
    print('')
