...
Authors: David Fisher and Joshua Eckels.
...
#
#       speed_in_inches_per_second = .01003 * speed_in_degrees_per_second +
#                                   .4732
#
...
#    any   question is 0.
# : 7. Formally test your work. When you think you have the problem complete run these tests to be sure:
...
def main():
    ...
    while True:
        ...
        if left_sp == 0:
            break
        right_sp = left_sp
        velocity = .01003 * left_sp + .4732
        distance = int(input("Enter a distance (inches): "))
        if distance == 0:
            break
        time_s = distance / velocity
