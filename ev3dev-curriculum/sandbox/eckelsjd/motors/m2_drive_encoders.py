...
def main():
    ...
    while True:
        speed_dps = int(input("Enter a speed (0 to 900 dps): "))
        ...
        if distance == 0:
            break
        dpi = 90
        position_rel = distance * dpi
        left_motor.run_to_rel_pos(speed_sp=speed_dps,
                                  position_sp=position_rel,
                                  stop_action="brake")
        right_motor.run_to_rel_pos(speed_sp=speed_dps,
                                   position_sp=position_rel,
                                   stop_action="brake")
