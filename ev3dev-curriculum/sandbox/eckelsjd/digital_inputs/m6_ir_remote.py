...
def main():
    ...
    remote2.on_red_up = lambda state: handle_red_up_2(state, robot)
    remote2.on_red_down = lambda state: handle_red_down_2(state, robot)
    remote2.on_blue_up = lambda state: handle_blue_up_2(state, robot)
...
def handle_red_up_2(state, robot):
    if state:
        robot.arm_up()


def handle_red_down_2(state, robot):
    if state:
        robot.arm_down()


def handle_blue_up_2(state, robot):
    if state:
