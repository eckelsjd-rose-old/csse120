...
def main():
    ...
    while True:
        ...
        left_motor.run_to_rel_pos(speed_sp=speed, position_sp=position, stop_action="brake")
        right_motor.run_to_rel_pos(speed_sp=speed, position_sp=position, stop_action="brake")
