...
def set_num_dice(mqtt_client, num_dice_entry):
    ...
    # DONE: 6. Write the line of code necessary to implement this method based on the doc string's description.p
    mqtt_client.send_message("set_number_of_dice", [int(set_num_dice())])
