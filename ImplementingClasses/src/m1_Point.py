...
class Point(object):
    ...
    def __init__(self, x, y):
        """Constructs a new point located at x and y"""
        self.x = x
        self.y = y
        self.count = 0
        self.start_x = x
    ...
    def move_to(self, x, y):
        """move this point to the new x and y location"""
    ...
    def move_by(self, dx, dy):
        """move this point by the given dx and dy"""
    ...
    def get_number_of_moves_made(self):
        """returns the number of times the point has been moved"""
        return self.count
    ...
    def get_distance_from_start(self):
        """returns distance from the point's starting location"""
        distance = math.sqrt((self.x - self.start_x) ** 2 + (self.y -
                                                             self.start_y) ** 2
                             )
        return distance

    def get_distance_traveled(self):
        """returns total distance traveled by this point"""
        return self.distance

    def closer_to(self, point2, point3):
        """returns which of the 2 input points this given point is closer to"""
        distance2 = math.sqrt((self.x - point2.x) ** 2 + (self.y - point2.y)
                              ** 2)
        distance3 = math.sqrt((self.x - point3.x) ** 2 + (self.y - point3.y)
                              ** 2)
    ...
    def halfway_to(self, point2):
        """returns a point halfway between this point and the given point"""
